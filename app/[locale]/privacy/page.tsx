...
export async function generateMetadata({
  ...
  return {
    title: 'Privacy Policy - BULEK EATS',
    description:
      'Privacy Policy for BULEK EATS food delivery service. Learn how we protect your personal information.',
  };
}
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-brand-red text-white py-16">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-red-100">{dict.privacy.lastUpdated}</p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-6">
          {Object.values(dict.privacy.sections).map((section, index) => (
            <Card
              key={index}
        ...
        <div className="mt-12 p-6 bg-red-50 rounded-lg border-l-4 border-brand-red">
          <p className="text-gray-700">
            ...
            delivery service operating in Algeria. For questions or concerns about this
